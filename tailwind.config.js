  ...
  theme: {
  	...
  	extend: {
  		...
  		boxShadow: {
  			...
  			feature: ' 0px -2px 10px 0px rgba(255, 255, 255, 0.3) inset, 0px 20px 30px 0px rgba(48, 48, 48, 0.25)',
  			...
  			'elevation-4': '0px 8px 20px 8px rgba(17, 17, 18, 0.16), 0px -8px 20px -8px rgba(17, 17, 18, 0.16)',
  			'elevation-5': '0px 20px 30px 0px rgba(0, 0, 0, 0.1)',
  			'elevation-6': '0px 6px 12px 0px rgba(0, 0, 0, 0.1)'
  		},
  		backgroundImage: {
  			'radial-gradient': 'radial-gradient(100% 100% at 50% 0%, rgba(255, 255, 255, 0.3) 0%, rgba(255, 255, 255, 0) 100%)',
  			'gradient-4': 'linear-gradient(180deg, #FCFCFF8D -22.24%, rgba(0, 0, 0, 0) 100%)',
